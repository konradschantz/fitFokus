...
-- CreateIndex
CREATE UNIQUE INDEX "Set_workoutId_orderIndex_key" ON "Set"("workoutId", "orderIndex");
...
-- AddForeignKey
ALTER TABLE "CardioSession" ADD CONSTRAINT "CardioSession_exerciseId_fkey" FOREIGN KEY ("exerciseId") REFERENCES "Exercise"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
